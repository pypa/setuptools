...
def validate_https___setuptools_pypa_io_en_latest_references_keywords_html(data, custom_formats):
    ...
    if data_is_dict:
        ...
        if "packages" in data_keys:
            ...
            data__packages_one_of_count = 0
            if data__packages_one_of_count < 2:
                try:
            ...
            if data__packages_one_of_count != 1:
            ...
            if data__packagedir_is_dict:
                ...
                if data__packagedir_len != 0:
                    ...
                    for data__packagedir_key in data__packagedir:
                        try:
                            data__packagedir_key_one_of_count = 0
                            if data__packagedir_key_one_of_count < 2:
                                try:
                                    ...
                                    data__packagedir_key_one_of_count += 1
                                except JsonSchemaValueException: pass
                            if data__packagedir_key_one_of_count < 2:
                                try:
                            ...
                            if data__packagedir_key_one_of_count != 1:
            ...
            if data__packagedata_is_dict:
                ...
                if data__packagedata_len != 0:
                    ...
                    for data__packagedata_key in data__packagedata:
                        try:
                            data__packagedata_key_one_of_count = 0
                            if data__packagedata_key_one_of_count < 2:
                                try:
                                    ...
                                    data__packagedata_key_one_of_count += 1
                                except JsonSchemaValueException: pass
                            if data__packagedata_key_one_of_count < 2:
                                try:
                            ...
                            if data__packagedata_key_one_of_count != 1:
            ...
            if data__excludepackagedata_is_dict:
                ...
                if data__excludepackagedata_len != 0:
                    ...
                    for data__excludepackagedata_key in data__excludepackagedata:
                        try:
                            data__excludepackagedata_key_one_of_count = 0
                            if data__excludepackagedata_key_one_of_count < 2:
                                try:
                                    ...
                                    data__excludepackagedata_key_one_of_count += 1
                                except JsonSchemaValueException: pass
                            if data__excludepackagedata_key_one_of_count < 2:
                                try:
                            ...
                            if data__excludepackagedata_key_one_of_count != 1:
        ...
        if "dynamic" in data_keys:
            ...
            if data__dynamic_is_dict:
                ...
                if "version" in data__dynamic_keys:
                    ...
                    data__dynamic__version_one_of_count = 0
                    if data__dynamic__version_one_of_count < 2:
                        try:
                            ...
                            data__dynamic__version_one_of_count += 1
                        except JsonSchemaValueException: pass
                    if data__dynamic__version_one_of_count < 2:
                        try:
                    ...
                    if data__dynamic__version_one_of_count != 1:
                ...
                if "readme" in data__dynamic_keys:
                    ...
                    data__dynamic__readme_any_of_count = 0
                    if not data__dynamic__readme_any_of_count:
                        try:
                            ...
                            data__dynamic__readme_any_of_count += 1
                        except JsonSchemaValueException: pass
                    if not data__dynamic__readme_any_of_count:
                        try:
...
def validate_https___setuptools_pypa_io_en_latest_references_keywords_html__definitions_file_directive(data, custom_formats):
    ...
    if data_is_dict:
        ...
        if "file" in data_keys:
            ...
            data__file_one_of_count = 0
            if data__file_one_of_count < 2:
                try:
...
def validate_https___www_python_org_dev_peps_pep_0621(data, custom_formats):
    ...
    if data_is_dict:
        ...
        if "readme" in data_keys:
            ...
            data__readme_one_of_count = 0
            if data__readme_one_of_count < 2:
                try:
            ...
            if data__readme_one_of_count < 2:
                try:
                    ...
                    data__readme_any_of_count = 0
                    if not data__readme_any_of_count:
                        try:
            ...
            if data__readme_one_of_count != 1:
        ...
        if "license" in data_keys:
            ...
            data__license_one_of_count = 0
            if data__license_one_of_count < 2:
                try:
            ...
            if data__license_one_of_count != 1:
