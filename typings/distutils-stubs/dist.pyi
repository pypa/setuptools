...
class Distribution:
    ...
    def parse_config_files(
        self, filenames: Iterable[StrPath] | None = None
    ) -> None: ...
    ...
    @overload
    def get_command_obj(self, command: Literal["bdist"], create: Literal[True] = True) -> bdist: ...
    @overload
    def get_command_obj(self, command: Literal["bdist_dumb"], create: Literal[True] = True) -> bdist_dumb: ...
    @overload
    def get_command_obj(self, command: Literal["bdist_rpm"], create: Literal[True] = True) -> bdist_rpm: ...
    @overload
    def get_command_obj(self, command: Literal["build"], create: Literal[True] = True) -> build: ...
    @overload
    def get_command_obj(self, command: Literal["build_clib"], create: Literal[True] = True) -> build_clib: ...
    @overload
    def get_command_obj(self, command: Literal["build_ext"], create: Literal[True] = True) -> build_ext: ...
    @overload
    def get_command_obj(self, command: Literal["build_py"], create: Literal[True] = True) -> build_py: ...
    @overload
    def get_command_obj(self, command: Literal["build_scripts"], create: Literal[True] = True) -> build_scripts: ...
    @overload
    def get_command_obj(self, command: Literal["check"], create: Literal[True] = True) -> check: ...
    @overload
    def get_command_obj(self, command: Literal["clean"], create: Literal[True] = True) -> clean: ...
    @overload
    def get_command_obj(self, command: Literal["config"], create: Literal[True] = True) -> config: ...
    @overload
    def get_command_obj(self, command: Literal["install"], create: Literal[True] = True) -> install: ...
    @overload
    def get_command_obj(self, command: Literal["install_data"], create: Literal[True] = True) -> install_data: ...
    @overload
    def get_command_obj(self, command: Literal["install_egg_info"], create: Literal[True] = True) -> install_egg_info: ...
    @overload
    def get_command_obj(self, command: Literal["install_headers"], create: Literal[True] = True) -> install_headers: ...
    @overload
    def get_command_obj(self, command: Literal["install_lib"], create: Literal[True] = True) -> install_lib: ...
    @overload
    def get_command_obj(self, command: Literal["install_scripts"], create: Literal[True] = True) -> install_scripts: ...
    @overload
    def get_command_obj(self, command: Literal["register"], create: Literal[True] = True) -> register: ...
    @overload
    def get_command_obj(self, command: Literal["sdist"], create: Literal[True] = True) -> sdist: ...
    @overload
    def get_command_obj(self, command: Literal["upload"], create: Literal[True] = True) -> upload: ...
    @overload
