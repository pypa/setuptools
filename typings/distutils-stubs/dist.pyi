...
class Distribution:
    ...
    @overload
    def get_command_obj(
        self, command: Literal["bdist"], create: Literal[True] = True
    ) -> bdist: ...
    @overload
    def get_command_obj(
        self, command: Literal["bdist_dumb"], create: Literal[True] = True
    ) -> bdist_dumb: ...
    @overload
    def get_command_obj(
    ...
    @overload
    def get_command_obj(
        self, command: Literal["build_scripts"], create: Literal[True] = True
    ) -> build_scripts: ...
    @overload
    def get_command_obj(
        self, command: Literal["check"], create: Literal[True] = True
    ) -> check: ...
    @overload
    def get_command_obj(
        self, command: Literal["clean"], create: Literal[True] = True
    ) -> clean: ...
    @overload
    def get_command_obj(
        self, command: Literal["config"], create: Literal[True] = True
    ) -> config: ...
    @overload
    def get_command_obj(
    ...
    @overload
    def get_command_obj(
        self, command: Literal["install_data"], create: Literal[True] = True
    ) -> install_data: ...
    @overload
    def get_command_obj(
    ...
    @overload
    def get_command_obj(
        self, command: Literal["install_headers"], create: Literal[True] = True
    ) -> install_headers: ...
    @overload
    def get_command_obj(
