...
def _set_platform_dir_class() -> type[PlatformDirsABC]:
    if sys.platform == "win32":
        from pkg_resources._vendor.platformdirs.windows import Windows as Result
    elif sys.platform == "darwin":
        from pkg_resources._vendor.platformdirs.macos import MacOS as Result
    else:
        from pkg_resources._vendor.platformdirs.unix import Unix as Result
    ...
    if os.getenv("ANDROID_DATA") == "/data" and os.getenv("ANDROID_ROOT") == "/system":
        ...
        from pkg_resources._vendor.platformdirs.android import _android_folder

        if _android_folder() is not None:
            from pkg_resources._vendor.platformdirs.android import Android
