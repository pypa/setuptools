...
.. _ez_setup.py: https://bitbucket.org/pypa/setuptools/raw/0.7.9/ez_setup.py
...
will download the appropriate version and install it for you::
    ...
    > wget https://bitbucket.org/pypa/setuptools/raw/0.7.9/ez_setup.py -O - | python
...
user-local path::
    ...
    > wget https://bitbucket.org/pypa/setuptools/raw/0.7.9/ez_setup.py
...
For example::
    ...
    setuptools-0.7.9$ python setup.py --prefix=/opt/setuptools
