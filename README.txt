...
.. _ez_setup.py: https://bitbucket.org/pypa/setuptools/raw/0.7.8/ez_setup.py
...
user-local path::
    ...
    > wget https://bitbucket.org/pypa/setuptools/raw/0.7.8/ez_setup.py
...
For example::
    ...
    setuptools-0.7.8$ python setup.py --prefix=/opt/setuptools
